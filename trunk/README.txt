...
# src/README.txt 2523 2007/12/12 09:37:41 knight
...
In this case, your options are:
    ...
    --  (Recommended.)  Install from a pre-packaged SCons package that
        does not require distutils:
            ...
            Debian GNU/Linux    scons_0.97.0d20071212-1_all.deb
                                (or use apt-get)

            Windows             scons-0.97.0d20071212.win32.exe
...
By default, the above command will do the following:
    ...
    --  Install the version-numbered "scons-0.97.0d20071212" and "sconsign-0.97.0d20071212"
    ...
    --  Install scripts named "scons" and "sconsign" scripts in the
        ...
        scripts be hard links or symbolic links to the "scons-0.97.0d20071212" and
        "sconsign-0.97.0d20071212" scripts by specifying the "--hardlink-scons"
        or "--symlink-scons" options on the command line.

    --  Install "scons-0.97.0d20071212.bat" and "scons.bat" wrapper scripts in the
        Python prefix directory on Windows (C:\Python*, for example).
        This can be disabled by specifying the "--no-install-bat" option
        on the command line.

        On UNIX or Linux systems, the "--install-bat" option may be
        specified to have "scons-0.97.0d20071212.bat" and "scons.bat" files
    ...
    --  Install the SCons build engine (a Python module) in an
        ...
        (/usr/lib/scons-0.97.0d20071212 or C:\Python*\scons-0.97.0d20071212, for example).
